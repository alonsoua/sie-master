(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			"<p class=\"AddOne\" rel=\"" + newName + "\" title=\"Agregar Seleccionado\">Pasar ></p>" +
			"<p class=\"AddAll\" rel=\"" + newName + "\" title=\"Agregar Todos\">Pasar Todos >> </p>" +
			"<p class=\"RemoveOne\" rel=\"" + newName + "\" title=\"Eliminar Seleccionado\">Quitar < </p>" +
			"<p class=\"RemoveAll\" rel=\"" + newName + "\" title=\"Eliminar Todos\">Quitar Todos << </p>" +
			"</div>" +
			"<div class=\"" + nameModifier + "select\">" +
			"<select name=\"" + originalName + arrayName + "\" id=\"" + newName + "\" size=\"" + size + "\"multiple=\"multiple\" size=\"10\" class=\"" + originalClass + "TakeOver\"></select>" +
			"</div>";
