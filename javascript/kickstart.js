...
jQuery(document).ready(function($){
	...
	$('ul.tabs a[href^="#"]').live('click', function(e){
		...
		//$(tab_next).show();
		$(tab_next).attr('style','display:flex');
		//buscamos el primer elemento y hacemos autofoco
        $(tab_next).find('input[type=text],select').filter(':visible:first').focus();
		return false;
	});
