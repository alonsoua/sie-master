$(function () {
    ...
    function contabilizar(lista, elemento) {
        ...
        for (var i = 0; i < lista.length; i++) {
            ...
            $(".entregada" + id).find('p').replaceWith('<p>' + entregada + '</p>');
            $(".noentregada" + id).find('p').replaceWith('<p style="color: white">' + noentregada + '</p>');
            $(".revisada" + id).find('p').replaceWith('<p>' + revisada + '</p>');
            $(".revisadain" + id).find('p').replaceWith('<p style="color: white">' + revisadain + '</p>');
            ...
            for (var k = 0; k < 4; k++) {
                ...
                switch (k) {
                    ...
                    case 0:
                        ...
                        $(elemento).find('.entregado p').replaceWith('<p>' + total + '</p>');
                        break;
                    case 1:
                    ...
                    case 3:
                        ...
                        $(elemento).find('.revisadoin p').replaceWith('<p style="color: white">' + total + '</p>');
                        break;
                        ...
                        for (var i = 0; i < data.notas.length; i++) {
                            ...
                            for (var k = 0; k < largo; k++) {
                                ...
                                switch (data.notas[i]['alumnos'][k]['valorGuia']) {
                                    ...
                                    case 0:
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector ' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" data-value="' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" style="background-color: gray" tabindex="g' + indg + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '">' + sel[0].outerHTML + '</div>');
                                        $(".selector[name='" + data.notas[i]['alumnos'][k]['idNotas'] + "'] select option[value='0']").prop('selected', true);

                                        break;

                                    case 1:
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector ' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" data-value="' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" style="background-color: pink" tabindex="g' + indg + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '">' + sel[0].outerHTML + '</div>');
                                        $(".selector[name='" + data.notas[i]['alumnos'][k]['idNotas'] + "'] select option[value='1']").prop('selected', true);

                                        break;
                                    case 2:
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector ' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" data-value="' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" style="background-color: blue"  tabindex="g' + indg + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '">' + sel[0].outerHTML + '</div>');
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector ' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + ' " data-value="' + data.notas[i]['alumnos'][k]['idAlumnosActual'] + '" style="background-color: darkgreen"  tabindex="g' + indg + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '">' + sel[0].outerHTML + '</div>');
                            ...
                            for (var k = 0; k < 4; k++) {
                                ...
                                switch (k) {
                                    ...
                                    case 0:
                                        ...
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector entregado" style="background-color: pink;" tabindex="es' + ind + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '"><p>' + total + '</p></div>');
                                        break;
                                    case 1:
                                        var total = $("div#guia" + data.notas[i]['idEvaluacion']).find('select option:selected[value="2"]').length;
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector noentregado" style="background-color: blue;"  tabindex="es' + ind + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '"><p style="color: white">' + total + '</p></div>');
                                        break;
                                    case 2:
                                        var total = $("div#guia" + data.notas[i]['idEvaluacion']).find('select option:selected[value="3"]').length;
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector revisado" style="background-color: yellow;"  tabindex="es' + ind + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '"><p>' + total + '</p></div>');
                                        break;

                                    case 3:
                                        var total = $("div#guia" + data.notas[i]['idEvaluacion']).find('select option:selected[value="4"]').length;
                                        $("div#guia" + data.notas[i]['idEvaluacion']).append('<div class="grid-item selector revisadoin" style="background-color: darkgreen;"  tabindex="es' + ind + '" name="' + data.notas[i]['alumnos'][k]['idNotas'] + '"><p style="color: white">' + total + '</p></div>');
                                        break;
    ...
    $('.estadoguia').live('change', function (e) {
        ...
        switch (id) {
            ...
            case 0:
                $(this).closest('div').attr('style', 'background-color:gray');
                break;
            case 1:
                $(this).closest('div').attr('style', 'background-color:pink');
                break;
            case 2:
                $(this).closest('div').attr('style', 'background-color:blue');
                break;
            case 3:
                $(this).closest('div').attr('style', 'background-color:yellow');
                break;
            case 4:
                $(this).closest('div').attr('style', 'background-color:darkgreen');
                break;
            case 5:
