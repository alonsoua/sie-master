  ...
  //creamos el json con los datos para enviar y guardar
      ...
      setTimeout(function(){ 
          $(".mensajes").fadeOut(800).fadeIn(800).fadeOut(500).fadeIn(500).fadeOut(300).remove();}, 3000); 
           ...
           $(document).ready(function(){
      setTimeout(function(){ 
          $(".exito").fadeOut(800).fadeIn(800).fadeOut(500).fadeIn(500).fadeOut(300).remove();}, 3000); 
});
             }
...
//si presiona boton guardar 
  ...
  //creamos el json con los datos para enviar y guardar
        var edited = "{"; 
         ...
         edited += '"0":{"ev":"'+id+'","valor":"'+valor+'","as":"'+as+'","cu":"'+cu+'","al":"'+al+'"},';
